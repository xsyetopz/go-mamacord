...
func (s reminderStore) CreateReminder(ctx context.Context, r automationstore.Reminder) error {
	...
	userID64, err := sqlvalue.Uint64ToInt64(r.UserID, "user_id")
	if err != nil {
		return err
	}
	guildAny, err := sqlvalue.OptionalUint64(r.GuildID, "guild_id")
	if err != nil {
		return err
	}
	channelAny, err := sqlvalue.OptionalUint64(r.ChannelID, "channel_id")
	if err != nil {
		return err
	}
...
LIMIT $4`
	...
	for rows.Next() {
		...
		userIDU64, err := sqlvalue.Int64ToUint64(userID64, "user_id")
		if err != nil {
			return nil, err
		}
...
func nullInt64ToUint64(v sql.NullInt64, field string) (uint64, bool, error) {
	...
	out, err := sqlvalue.Int64ToUint64(v.Int64, field)
	if err != nil {
		return 0, false, err
	}
	return out, true, nil
