...
type DiscordPermissions struct {
	DiscordIdentityPermissions
	DiscordContentPermissions
	DiscordIntegrationPermissions
}

type DiscordIdentityPermissions struct {
...
type DiscordContentPermissions struct {
...
type DiscordIntegrationPermissions struct {
...
func Effective(requested, granted Permissions) Permissions {
	return Permissions{
		...
		Discord: DiscordPermissions{
			DiscordIdentityPermissions: DiscordIdentityPermissions{
			...
			DiscordContentPermissions: DiscordContentPermissions{
			...
			DiscordIntegrationPermissions: DiscordIntegrationPermissions{
