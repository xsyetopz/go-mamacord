...
import (
	...
	"errors"
	"fmt"
	"github.com/xsyetopz/go-mamacord/internal/runtime/plugins/internal/jsonobject"
	"io"
	"maps"
	"os"
	"regexp"
...
func ReadTrustedKeysFile(path string) (map[string]ed25519.PublicKey, error) {
	...
	if err := jsonobject.RejectDuplicateKeys(b); err != nil {
...
func ParseSignature(data []byte) (Signature, error) {
	...
	if err := jsonobject.RejectDuplicateKeys(data); err != nil {
		return Signature{}, err
	}
