...
`
	...
	command := contract.Invocation{InvocationIdentity: contract.InvocationIdentity{PluginID: "example", Generation: generation.ID(), Route: "command:slash:example", Kind: contract.InvocationCommand}, InvocationInteractionContext: contract.InvocationInteractionContext{ResponseState: contract.ResponseUnacknowledged}, InvocationActorContext: contract.InvocationActorContext{Guild: &contract.GuildRef{ID: "10"}, Author: &contract.UserRef{ID: "30"}}, InvocationExecutionContext: contract.InvocationExecutionContext{State: []contract.StateEntry{{Key: "counter", Value: mustObjectValue(t, []contract.Field{{Key: "count", Value: contract.IntValue(1)}})}}}, InvocationInput: contract.InvocationInput{Command: &contract.CommandInput{Kind: contract.CommandSlash, Path: []string{"example"}, Options: []contract.OptionValue{{Name: "name", Kind: contract.OptionString, ScalarOptionValue: contract.ScalarOptionValue{String: "Mamacord"}}}}}}
	outcome, err := generation.InvokeWithServices(context.Background(), command, contextapi.InvocationServices{Capabilities: []contract.Capability{contract.CapabilityStorageKV}}, nil)
	if err != nil {
	...
	component := contract.Invocation{InvocationIdentity: contract.InvocationIdentity{PluginID: "example", Generation: generation.ID(), Route: "component:save", Kind: contract.InvocationComponent}, InvocationInteractionContext: contract.InvocationInteractionContext{ResponseState: contract.ResponseUnacknowledged}, InvocationActorContext: contract.InvocationActorContext{Guild: &contract.GuildRef{ID: "10"}, Author: &contract.UserRef{ID: "30"}}, InvocationInput: contract.InvocationInput{Component: &contract.ComponentInput{ID: "save", Kind: contract.ComponentButton}}}
	...
	modal := contract.Invocation{InvocationIdentity: contract.InvocationIdentity{PluginID: "example", Generation: generation.ID(), Route: "modal:edit", Kind: contract.InvocationModal}, InvocationInteractionContext: contract.InvocationInteractionContext{ResponseState: contract.ResponseUnacknowledged, ModalOrigin: contract.ModalOriginCommand}, InvocationActorContext: contract.InvocationActorContext{Author: &contract.UserRef{ID: "30"}}, InvocationInput: contract.InvocationInput{Modal: &contract.ModalInput{ID: "edit", Fields: []contract.NamedString{{Name: "text", Value: "saved"}}}}}
	...
	autocomplete := contract.Invocation{InvocationIdentity: contract.InvocationIdentity{PluginID: "example", Generation: generation.ID(), Route: "autocomplete:slash:example:count", Kind: contract.InvocationAutocomplete}, InvocationInteractionContext: contract.InvocationInteractionContext{ResponseState: contract.ResponseUnacknowledged}, InvocationActorContext: contract.InvocationActorContext{Author: &contract.UserRef{ID: "30"}}, InvocationInput: contract.InvocationInput{Autocomplete: &contract.AutocompleteInput{Path: []string{"example"}, Option: "count", Focused: contract.OptionValue{Name: "count", Kind: contract.OptionInteger, ScalarOptionValue: contract.ScalarOptionValue{Integer: 1}}}}}
	...
	check := contract.Invocation{InvocationIdentity: contract.InvocationIdentity{PluginID: "example", Generation: generation.ID(), Route: "check:policy", Kind: contract.InvocationCheck}, InvocationActorContext: contract.InvocationActorContext{Author: &contract.UserRef{ID: "30"}}, InvocationInput: contract.InvocationInput{Check: &contract.CheckInput{}}}
...
`
	generation := buildTestGeneration(t, source)
	invocation := contract.Invocation{InvocationIdentity: contract.InvocationIdentity{PluginID: "example", Generation: generation.ID(), Route: "command:slash:deferred", Kind: contract.InvocationCommand}, InvocationInteractionContext: contract.InvocationInteractionContext{ResponseState: contract.ResponseDeferredCreate}, InvocationActorContext: contract.InvocationActorContext{Author: &contract.UserRef{ID: "1"}}, InvocationInput: contract.InvocationInput{Command: &contract.CommandInput{Kind: contract.CommandSlash, Path: []string{"deferred"}}}}
...
`
	generation := buildTestGeneration(t, source)
	invocation := contract.Invocation{InvocationIdentity: contract.InvocationIdentity{PluginID: "example", Generation: generation.ID(), Route: "command:slash:bad", Kind: contract.InvocationCommand}, InvocationInteractionContext: contract.InvocationInteractionContext{ResponseState: contract.ResponseUnacknowledged}, InvocationActorContext: contract.InvocationActorContext{Author: &contract.UserRef{ID: "1"}}, InvocationInput: contract.InvocationInput{Command: &contract.CommandInput{Kind: contract.CommandSlash, Path: []string{"bad"}}}}
	if _, err := generation.Invoke(context.Background(), invocation, nil); err == nil || !evaluation.IsErrorKind(err, evaluation.ErrorResult) {
		t.Fatalf("invalid result error: %v", err)
	}
	invocation.Generation = "old"
	if _, err := generation.Invoke(context.Background(), invocation, nil); err == nil || !evaluation.IsErrorKind(err, evaluation.ErrorStale) {
...
`
	generation := buildTestGeneration(t, source)
	invocation := contract.Invocation{InvocationIdentity: contract.InvocationIdentity{PluginID: "example", Generation: generation.ID(), Route: "command:slash:concurrent", Kind: contract.InvocationCommand}, InvocationInteractionContext: contract.InvocationInteractionContext{ResponseState: contract.ResponseUnacknowledged}, InvocationActorContext: contract.InvocationActorContext{Author: &contract.UserRef{ID: "1"}}, InvocationInput: contract.InvocationInput{Command: &contract.CommandInput{Kind: contract.CommandSlash, Path: []string{"concurrent"}}}}
...
PLUGIN=plugin(setup=setup)
`
	invocation := contract.Invocation{InvocationIdentity: contract.InvocationIdentity{PluginID: "example", Generation: "generation-1", Route: "command:slash:bounded", Kind: contract.InvocationCommand}, InvocationInteractionContext: contract.InvocationInteractionContext{ResponseState: contract.ResponseUnacknowledged}, InvocationActorContext: contract.InvocationActorContext{Author: &contract.UserRef{ID: "1"}}, InvocationInput: contract.InvocationInput{Command: &contract.CommandInput{Kind: contract.CommandSlash, Path: []string{"bounded"}}}}
	...
	if _, err := stepGeneration.Invoke(context.Background(), invocation, nil); err == nil || !evaluation.IsErrorKind(err, evaluation.ErrorStepLimit) {
	...
	if _, err := deadlineGeneration.Invoke(context.Background(), invocation, nil); err == nil || !evaluation.IsErrorKind(err, evaluation.ErrorDeadline) {
	...
	cancel()
	if _, err := canceledGeneration.Invoke(ctx, invocation, nil); err == nil || !evaluation.IsErrorKind(err, evaluation.ErrorCanceled) {
...
func (localizer *testLocalizer) Localize(_ context.Context, request contextapi.LocalizationRequest) (string, error) {
	localizer.calls++
...
`
	generation := buildTestGeneration(t, source)
	invocation := contract.Invocation{InvocationIdentity: contract.InvocationIdentity{PluginID: "example", Generation: generation.ID(), Route: "command:slash:localized", Kind: contract.InvocationCommand}, InvocationInteractionContext: contract.InvocationInteractionContext{ResponseState: contract.ResponseUnacknowledged}, InvocationActorContext: contract.InvocationActorContext{Locale: "en-US", Author: &contract.UserRef{ID: "1"}}, InvocationInput: contract.InvocationInput{Command: &contract.CommandInput{Kind: contract.CommandSlash, Path: []string{"localized"}}}}
	localizer := &testLocalizer{}
	outcome, err := generation.InvokeWithServices(context.Background(), invocation, contextapi.InvocationServices{Localizer: localizer}, nil)
	if err != nil {
	...
	if _, err := generation.InvokeWithServices(context.Background(), invocation, contextapi.InvocationServices{Localizer: localizer}, nil); err == nil || !evaluation.IsErrorKind(err, evaluation.ErrorInvocation) {
...
`
	...
	route := contract.RouteID("command:slash:drain")
	original := generation.routes[route]
	generation.routes[route] = starlarkgo.NewBuiltin("blocked", func(thread *starlarkgo.Thread, _ *starlarkgo.Builtin, args starlarkgo.Tuple, kwargs []starlarkgo.Tuple) (starlarkgo.Value, error) {
		close(started)
		<-unblock
		return starlarkgo.Call(thread, original, args, kwargs)
	})
	invocation := contract.Invocation{InvocationIdentity: contract.InvocationIdentity{PluginID: "example", Generation: generation.ID(), Route: "command:slash:drain", Kind: contract.InvocationCommand}, InvocationInteractionContext: contract.InvocationInteractionContext{ResponseState: contract.ResponseUnacknowledged}, InvocationActorContext: contract.InvocationActorContext{Author: &contract.UserRef{ID: "1"}}, InvocationInput: contract.InvocationInput{Command: &contract.CommandInput{Kind: contract.CommandSlash, Path: []string{"drain"}}}}
...
func buildTestGeneration(t *testing.T, source string) *Generation {
	...
	generation, err := BuildInitialized(context.Background(), initialized, "generation-1", nil)
	if err != nil {
