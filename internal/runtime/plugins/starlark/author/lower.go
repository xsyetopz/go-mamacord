...
func (lowerer *generationLowerer) lowerCommands(values []*apiValue, parent []string) ([]contract.CommandDefinition, error) {
	...
	for index, value := range values {
		...
		command := contract.CommandDefinition{Kind: kind, Name: declaration.name, CommandDescription: contract.CommandDescription{Description: declaration.description, DescriptionID: declaration.descriptionID}, CommandResponse: contract.CommandResponse{Ephemeral: declaration.ephemeral}}
...
func (lowerer *generationLowerer) lowerOptions(values []*apiValue, commandRoute contract.RouteID) ([]contract.OptionDefinition, error) {
	...
	for index, value := range values {
		...
		option := contract.OptionDefinition{Name: declaration.name, Kind: kind, OptionDescription: contract.OptionDescription{Description: declaration.description, DescriptionID: declaration.descriptionID}, Required: declaration.required, IntegerOptionBounds: contract.IntegerOptionBounds{MinInteger: clonePointer(declaration.minInteger), MaxInteger: clonePointer(declaration.maxInteger)}, NumberOptionBounds: contract.NumberOptionBounds{MinNumber: clonePointer(declaration.minNumber), MaxNumber: clonePointer(declaration.maxNumber)}, StringOptionBounds: contract.StringOptionBounds{MinLength: clonePointer(declaration.minLength), MaxLength: clonePointer(declaration.maxLength)}}
